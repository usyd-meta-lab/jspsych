  ...
  class HtmlSliderResponsePlugin {
      ...
      trial(display_element, trial) {
          ...
          for (var j = 0; j < trial.labels.length; j++) {
              ...
              console.log(label_width_perc, percent_of_range, percent_dist_from_center, offset)
              html +=
          ...
          html += "</div>";
          html += '<div id = "showValue" style = "color:darkblue"><p>'+trial.slider_start+'%</p></div>'
          html += "</div>";
          ...
          display_element.querySelector('#jspsych-html-slider-response-response').addEventListener('input', function(){
            document.getElementById("showValue").innerHTML = '<p>' + document.getElementById("jspsych-html-slider-response-response").value + '%</p>';
          });
